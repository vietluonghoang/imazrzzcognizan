...
public class OpenCVFindContours {
	...
	public void example() {
		...
		Mat image = Highgui.imread("/Users/quannd/Desktop/screenshot/Screenshot_2016-01-08-15-19-34.png",
		...
		Highgui.imwrite("/Users/quannd/Desktop/Quan/Eclipe/appium/screenshot/26c8b4eb/00_grayscale_01_with_results.png",
				image);
	}
...
//		}
		...
		//----------------------------------------
//		System.out.println("arraylist sau khi so sanh:");
//		for (int i = 0; i < arraylist.size(); i++) {
//			System.out.println(arraylist.get(i));
//		}
		//----------------------------------------
